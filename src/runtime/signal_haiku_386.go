...
// Haiku does not expose the segment register selectors in mcontext;
// the runtime only reads these for diagnostic prints, so report 0.
func (c *sigctxt) cs() uint32 { return 0 }

...
func sighandler(sig uint32, info *siginfo, ctxt unsafe.Pointer, gp *g) {
	...
	// non-canonical address — as SIGILL with si_code ILL_PRVOPC (0xe)
	// rather than SIGSEGV. Treat that as a memory fault so nil-pointer
	// recovery and debug.SetPanicOnFault behave as on other systems.
	// A genuine illegal instruction reports ILL_ILLOPC and is left alone.

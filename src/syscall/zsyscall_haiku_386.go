...
//go:cgo_import_dynamic libc_writev writev "libroot.so"
...
//go:cgo_import_dynamic libc_futimes futimes "libroot.so"
...
//go:cgo_import_dynamic libc_getpgrp getpgrp "libroot.so"
...
//go:cgo_import_dynamic libc_waitpid waitpid "libroot.so"
//go:cgo_import_dynamic libc_fork fork "libroot.so"
//go:cgo_import_dynamic libc_vfork vfork "libroot.so"
...
//go:cgo_import_dynamic libc_getrusage getrusage#LIBROOT_1_BETA3 "libroot.so"
//go:cgo_import_dynamic libc_getrlimit getrlimit "libroot.so"
//go:cgo_import_dynamic libc_setrlimit setrlimit "libroot.so"
//go:cgo_import_dynamic libc_kern_read_dir _kern_read_dir "libroot.so"
//go:cgo_import_dynamic libc_kern_open_dir _kern_open_dir "libroot.so"
//go:cgo_import_dynamic libc_kern_rewind_dir _kern_rewind_dir "libroot.so"
//go:cgo_import_dynamic libc_flock flock "libroot.so"
//go:cgo_import_dynamic libc_find_path find_path "libroot.so"
...
//go:cgo_import_dynamic libc_tcgetpgrp tcgetpgrp "libroot.so"
//go:cgo_import_dynamic libc_tcsetpgrp tcsetpgrp "libroot.so"
...
//go:cgo_import_dynamic libc_kill_thread kill_thread "libroot.so"
//go:cgo_import_dynamic libc_wait_for_thread wait_for_thread "libroot.so"
//go:cgo_import_dynamic libc_get_next_thread_info _get_next_thread_info "libroot.so"
...
func pread(fd int, p []byte, off int64) (n int, err error) {
	...
	r0, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_pread)), 5,
		uintptr(fd), uintptr(unsafe.Pointer(_p0)), uintptr(len(p)), uintptr(off), uintptr(off>>32), 0)
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func pwrite(fd int, p []byte, off int64) (n int, err error) {
	...
	r0, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_pwrite)), 5,
		uintptr(fd), uintptr(unsafe.Pointer(_p0)), uintptr(len(p)), uintptr(off), uintptr(off>>32), 0)
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
...
func lseek(fd int, offset int64, whence int) (int64, error) {
	r0, r2, e1 := syscall6(uintptr(unsafe.Pointer(&libc_lseek)), 4,
		uintptr(fd), uintptr(offset), uintptr(offset>>32), uintptr(whence), 0, 0)
	if e1 != 0 {
	...
	return int64(r0) | int64(r2)<<32, nil
}
...
func truncate(path string, length int64) error {
	...
	_, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_truncate)), 3,
		uintptr(unsafe.Pointer(p)), uintptr(length), uintptr(length>>32), 0, 0, 0)
	if e1 != 0 {
		return errnoErr(e1)
	}
	return nil
...
func ftruncate(fd int, length int64) error {
	_, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_ftruncate)), 3,
		uintptr(fd), uintptr(length), uintptr(length>>32), 0, 0, 0)
	if e1 != 0 {
		return errnoErr(e1)
	}
	return nil
